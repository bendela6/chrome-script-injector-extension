...
import { loadScripts, saveScripts, getCurrentTab, isScriptMatched } from '../utils/storage';
import { executeScriptInTab } from '../utils/scriptInjection';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
        ...
        {filteredScripts.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {filteredScripts.map(script => {
              const matched = isScriptMatched(script, currentUrl);
              ...
              return (
                <div
                  ...
                  className={`bg-white rounded-lg shadow-md hover:shadow-xl transition-all border-2 ${
                    matched ? 'border-green-400 bg-green-50' : 'border-slate-200'
                  }`}
                >
                  <div className="p-6">
      ...
      <Modal
        ...
        title={editingScriptId !== null ? 'Edit Script' : 'New Script'}
      >
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            <Button onClick={handleSaveScript} variant="primary" className="flex-1">
              💾 Save Script
            </Button>
